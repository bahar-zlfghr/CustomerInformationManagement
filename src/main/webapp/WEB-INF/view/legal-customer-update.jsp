...
<head>
    <title><fmt:message key="legal.customer.update.page.title"/></title>
...
<div class="container rounded-3" style="margin: 100px auto">
    <div class="alert alert-primary" role="alert">
        <h5><fmt:message key="legal.customer.update.message"/></h5>
    </div>
        ...
        <table class="table" dir="rtl">
            ...
            <tr>
                ...
                <td>
                    ...
                    <label>
                        <input type="text" value="${legalCustomer.customerNO}" readonly onclick="alert('<fmt:message key="customer.no.alert.not.changed"/>')"/>
                    </label>
                </td>
            </tr>
            <tr>
